...
- [ ] Hyödynnä autentikointia ja tee harjoituksen vuoksi pari testiä [Test login](https://practicetestautomation.com/practice-test-login/) -sovellukselle.
...
| npx playwright --version | tarkasta onko Playwright asennettu ja jos on, näytä sen versio |
